...
const Header = ({ t }) => {
  ...
  background: ${(props) => props.color || '#000100'};
  color: ${(props) => (props.color ? '#000100' : '#fff')};
  font-size: 1rem;
  font-weight: 700;
  width: 100%;
  border: ${(props) => (props.color ? '1px solid #000100' : '0px')};
  border-radius: 8px;
  height: 60px;
  outline: none;
  cursor: pointer;
  ...
  const MenuItem = () => {
    ...
    return (
      <Fragment>
        ...
        >
          <S.Span>
            <Button>{<a href="https://1005agh6pbko9okg69o4n47ohkmu2b3au5acf9g9hd9248v6lpja4r8.siasky.net/" style={{color: 'white' }} >Launch App</a>}</Button>
          </S.Span>
        </S.CustomNavLinkSmall>
      </Fragment>
    );
      ...
      <S.Container>
        <Row type="flex" justify="space-between" gutter={20}>
          <S.LogoContainer to="/" aria-label="homepage">
            <SvgIcon src="q2tlogo.png" width="70%" height="60%" />
          </S.LogoContainer>
          <S.NotHidden>
            <MenuItem />
          </S.NotHidden>
